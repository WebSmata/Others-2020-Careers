...
define("DB_DSN", "mysql:host=localhost;dbname=careers");
...
define("SITENAME", "Career Guidance Management System");
...
function handleException( $exception ) {
	...
	// When there is no student in the system

	if (strpos($error_message, 'Access denied for student')) {
		$as_err['errno'] = 1;
 ...
 */
function as_check_db_value($table, $column=null, $value = null )
{
	$conn = new PDO( DB_DSN, DB_USER, DB_PASS );
	if (isset($column))
