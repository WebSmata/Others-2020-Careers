<?php 
	...
	function as_navigation($request, $html = '')
	{
		...
		$navigation = array();
		if ( $adminid ) {			
			$navigation['students'] = array('label' => 'Students', 'url' => 'admin.php?open=student_all');
			$navigation['grades'] = array('label' => 'grades', 'url' => 'admin.php?open=grade_all');
			$navigation['courses'] = array('label' => 'Courses', 'url' => 'admin.php?open=course_all');
