			...
			if ( isset( $_GET['error'] ) ) {
				switch ( $_GET['error'] ) {
					case "postNotFound":
						...
						break;
					case "userNotFound":
						$content['errorMessage'] = "Error: student not found.";
						break;
				}
			}
			...
			if ( isset( $_GET['status'] ) ) {
				switch ( $_GET['status'] ) {
					...
					case "postDeleted":
						...
						break;
					case "adminsaved":
						$content['statusMessage'] = "A new student has been saved.";
						break;
					case "changesSaved":
						$content['statusMessage'] = "Your changes have been saved.";
						break;
					case "userDeleted":
						$content['statusMessage'] = "That student has been deleted successfully!.";
						break;
				}
			}
		?>
...
<div id="tooplate_body_wrapper">
	<div id="tooplate_wrapper">
        ...
        <div id="tooplate_header">
            <div id="header_right"><h1 id="sitename" style="float: left;margin-left: 50px;"><?php echo $content['sitename'] ?></h1> <?php if (isset($studentid)) { ?><pre style="float: left; background: #fff;color: #000; padding: 2px 5px; margin-left: 5px; border-radius: 3px;"><b><?php echo $fullname; ?></b></pre><?php } ?>
