<?php 
	...
	function as_navigation($request, $html = '')
	{
		...
		$navigation = array();
		if ( $adminid ) {			
			$navigation['students'] = array('label' => 'Students', 'url' => 'index.php?open=student_all');
			$navigation['courses'] = array('label' => 'Courses', 'url' => 'index.php?open=course_all');
...
<div id="tooplate_content">   	
	<h2>
		...
		<?php echo (isset($content['custom']) ? '<hr>'.$content['custom'] : '') ?>
